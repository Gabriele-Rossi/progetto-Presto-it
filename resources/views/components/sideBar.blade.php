<div id="mySidebar" class="sidebar">
    <div class="subSidebar">
        <a href="{{route('product.index')}}" class="liNav"><span><i class="material-icons text-dropdown">info</i><span class="text-white icon-text">{{__('ui.sidebarAnnouncements')}}</span></a><br>
        <div class="nav-item dropdown">       
            <div>
                <a class="py-2 pe-3 liNav active dropdown-toggle collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#categoriesDropDown" aria-expanded="false" href="#"><i class="text-dropdown material-icons">search</i><span class="text-white icon-text">{{__('ui.sidebarCategory')}}</span></a><br>
        ...
        <div class="nav-item dropdown">       
          <div>
              <a class="py-2 pe-3 liNav active dropdown-toggle text-white collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#categoriesDropDown1" aria-expanded="false" href="#"><i class="text-dropdown material-icons">work</i><span class=" icon-text">{{__('ui.spaceRevisor')}}</span></a><br>
